...
public class TeaVMBuilder {
    ...
    public static void main(String[] args) throws IOException {
        ...
        teaBuildConfiguration.htmlTitle = "KFS Boulder Dash pro Kubu";

        // Register any extra classpath assets here:
        // teaBuildConfiguration.additionalAssetsClasspathFiles.add("kfs/BoulderDash/asset.extension");

        // Register any classes or packages that require reflection here:
        // TeaReflectionSupplier.addReflectionClass("kfs.BoulderDash.reflect");
